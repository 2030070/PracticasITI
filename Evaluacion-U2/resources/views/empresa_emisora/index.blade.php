...
@section('contenido')
    <div class="my-4 flex justify-end space-x-2">
        @auth
        <button onclick="exportToPDF('empresas_emisoras')" class="inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-blue-500 hover:bg-blue-700 transition-colors">
        ...
        <button onclick="exportToExcel('empresas_emisoras')" class="inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-blue-500 hover:bg-blue-700 transition-colors">
                    ...
                    @foreach ($empresaEmisora as $empresa)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-2 border-blue-400">
                                <form action="{{ route('empresas_emisoras.destroy', $empresa->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
