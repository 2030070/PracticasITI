...
@section('contenido')
    @auth
        <div class="grid grid-cols-2 gap-6 justify-center items-center">
            ...
            <a href="{{ route('consultar') }}" class="bg-blue-100 rounded-lg p-4 hover-float zoom-in flex flex-col justify-center items-center h-40 w-2/4" style="background-image: url('ruta_de_la_imagen')">
                {{-- Contenido del primer recuadro --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="125" height="125" fill="#000000" viewBox="0 0 256 256">
