                      ...
                      <form method="POST" action="{{route('logout')}}">
                        ...
                        <button type="submit" class="font-bold uppercase text-bold text-white text-sm flex items-center">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#ffffff" viewBox="0 0 256 256">
                            <path d="M112,216a8,8,0,0,1-8,8H48a16,16,0,0,1-16-16V48A16,16,0,0,1,48,32h56a8,8,0,0,1,0,16H48V208h56A8,8,0,0,1,112,216Zm109.66-93.66-40-40a8,8,0,0,0-11.32,11.32L196.69,120H104a8,8,0,0,0,0,
                            16h92.69l-26.35,26.34a8,8,0,0,0,11.32,11.32l40-40A8,8,0,0,0,221.66,122.34Z"></path>
                          </svg>
                        </button>
                      </form>
                    </nav>
                  ...
                  @guest
                    <div class="hidden md:block">
                      <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a class="flex items-center space-x-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium" href="{{ route('consultar') }}">
                          <svg xmlns="http://www.w3.org/2000/svg" width=28" height="28" fill="#FFFFFF" viewBox="0 0 256 256">
                    ...
                    <div class="hidden md:block">
                      <div class="ml-10 flex items-baseline space-x-4">
                        <a class="flex items-center space-x-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-base font-medium" href="{{route('login')}}"> Login</a>
