    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <div class="col-span-2 md:col-span-5">
            <div class="flex justify-end"> <!-- Alineación a la derecha -->
                <a href="{{ route('usuarios.create') }}" class="inline-block ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-purple-400">
            ...
            <div class="overflow-x-auto">
                <table id="usuarios-table" class="min-w-full border-2 border-blue-500 rounded-lg">
                    <thead>
                        <tr>
