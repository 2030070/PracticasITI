    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <div class="col-span-2 md:col-span-5">
            <div class="flex justify-end"> <!-- Alineación a la derecha -->
                <a href="{{ route('registrar-cotizacion-form') }}" class="inline-block ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-purple-400">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">
                                ...
                                {{-- <a href="{{ route('actualizar-estado-cotizacion', $cotizacion->id) }}" >
