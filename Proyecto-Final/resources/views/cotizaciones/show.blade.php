    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <div class="col-span-2 md:col-span-5">
            <div class="flex justify-end"> <!-- Alineación a la derecha -->
                <a href="{{ route('cotizaciones.create') }}" class="inline-block ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-purple-400">
                    <i class="fas fa-plus mr-2"></i> Registrar Cotizacion
                </a>
            </div>
            @if(session('success'))
                ...
                <table id="productos-table" class="min-w-full border-2 border-blue-500 rounded-lg">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">{{ $cotizacion->producto->precio_compra }}</td>
