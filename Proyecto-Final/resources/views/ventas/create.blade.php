                            ...
                            <div class="flex justify-center px-4 py-2">
                                <form method="POST" action="{{ route('ventas.store') }}">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        ...
                                        <div class="mb-4">
                                            <label for="referencia" class="font-semibold">Referencia</label>
                                            <input style="margin-top: 10px;" class="focus:shadow-primary-outline  dark:placeholder:text-white/80  text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-bñue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" type="text" name="referencia" placeholder="Referencia">
                                        </div>
                                        <div class="mb-4">
                                            <label for="fecha" class="font-semibold">Fecha</label>
                                            <input style="margin-top: 10px;" class="focus:shadow-primary-outline  dark:placeholder:text-white/80  text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-bñue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" type="date" name="fecha" value="{{$fechaActual}}" >
                                        </div>
                                        <div class="mb-4">
                                            <label for="Pago" class="font-semibold">Pago</label>
                                            <input style="margin-top: 10px;" class="focus:shadow-primary-outline  dark:placeholder:text-white/80  text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-bñue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" type="number" step=0.1 name="pago" placeholder="Pago" >
                                        </div>
