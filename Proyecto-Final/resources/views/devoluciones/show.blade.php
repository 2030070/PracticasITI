                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b text-left">
                                <a class="inline-block bg-green-300 rounded-lg px-4 py-2 border border-green-300 hover:bg-green-400 hover:border-green-400 hover:text-white transition"  href="{{ route('ventas.detalle', ['id' => $devolucion->venta->id]) }}">Ver Venta</a></th>
