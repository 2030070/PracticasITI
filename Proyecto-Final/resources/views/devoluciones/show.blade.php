    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
        ...
        <div class="col-span-2 md:col-span-5">
            <div class="flex justify-end"> <!-- Alineación a la derecha -->
                <a href="{{ route('devoluciones.create') }}" class="inline-block ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-purple-400">
                ...
                <table  id="devoluciones-table" class="min-w-full border-2 border-blue-500 rounded-lg">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b text-left">Pagado</th>
                            <th class="py-2 px-4 border-b text-left">Adeudo</th>
                            <th class="py-2 px-4 border-b text-left">Estatus del Pago</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="py-2 px-4 border-b">{{ $devolucion->nombre_producto }}</td>
                            ...
                            <td class="py-2 px-4 border-b">
                                ...
                                <a href="{{ route('devoluciones.edit', $devolucion->id) }}" >
