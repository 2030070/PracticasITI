          ...
          <form action="{{ route('devoluciones.store') }}" method="POST">
              ...
              <div class="mb-4 flex">
                <div class="w-1/2 mr-2">
                  ...
                  <input type="text" name="cliente" id="cliente" class="focus:shadow-primary-outline dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-blue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" step="0.01" min="0" placeholder="Ingrese el cliente">
                </div>
