          ...
          <form action="{{ route('devoluciones.update', $devolucion->id) }}" method="POST">
              ...
              <div class="mb-4 flex">
                <div class="w-1/2 mr-2">
                  ...
                  <input type="text" name="nombre_producto" id="nombre_producto" class="focus:shadow-primary-outline dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-blue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" step="0.01" min="0" placeholder="Ingrese el nombre del producto" value="{{ $devolucion->nombre_producto }}">
                </div>
              ...
              <div class="mb-4 flex">
                <div class="w-1/2 mr-2">
                  <label for="cliente" class="block mb-2 font-semibold">Cliente:</label>
                  <input type="text" name="cliente" id="cliente" class="focus:shadow-primary-outline dark:text-white/80 text-sm leading-5.6 ease block w-full appearance-none rounded-lg border-2 border-blue-500 bg-white bg-clip-padding p-3 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none" step="0.01" min="0" placeholder="Ingrese el cliente" value="{{ $devolucion->cliente }}">
                </div>
