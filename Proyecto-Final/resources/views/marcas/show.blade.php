    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="col-span-2 md:col-span-3">
            <div class="flex justify-end"> <!-- Alineación a la derecha -->
                <a href="{{ route('marcas.create') }}" class="inline-block ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-purple-400">
                    <i class="fas fa-plus mr-2"></i> Registrar Marca
                </a>
            </div>
            @if(session('success'))
            ...
            <div class="overflow-x-auto">
                <table id="marcas-table" class="min-w-full border-2 border-blue-500 rounded-lg">
                    <thead>
                        <tr>
